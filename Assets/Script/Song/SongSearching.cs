...
namespace YARG.Song
{
    public class SongSearching
    {
        public IReadOnlyList<SongCategory> Refresh(SortAttribute sort, Instrument instrument)
        {
            ...
            {
                SortAttribute.Instrument => GlobalVariables.Instance.SongContainer[instrument],
                SortAttribute.Playable => GlobalVariables.Instance.SongContainer.GetPlayableSongs(PlayerContainer.Players),
                _ => GlobalVariables.Instance.SongContainer[sort]
            };
        ...
        {
            var songsToMatch = GlobalVariables.Instance.SongContainer.Instruments[instrument]
